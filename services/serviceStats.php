...
class ServiceStats {
    ...
    private static function getTotalHeuresMedecin($id) {
    ...
    public static function getHeuresMedecins() {
    ...
    public static function getCountUsagerAgeSexe(int $age, int $civilite) {
